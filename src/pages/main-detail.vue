<template>
	<transition name="show">
		<div id="main-detail">
			...
			<div v-show="showbody" v-html="body" class="mainDetail-wrapper"></div>
			<scrolltop></scrolltop>
		</div>
	</transition>
</template>
	...
	export default {
		...
		methods: {
			_fetchData() {
				...
				this.$http.get('https://bird.ioliu.cn/v1/?url=https://news-at.zhihu.com/api/4/news/'+id)
				.then(response=>{
...
<style lang="scss">
	...
	.swipLeft-enter-active,
	.swipLeft-leave-active {
